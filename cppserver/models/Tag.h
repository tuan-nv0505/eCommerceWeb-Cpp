...
class Tag
{
  public:
    struct Cols
    {
        ...
        static const std::string _tagcol;
    };
    ...
    /**  For column tagcol  */
    ///Get the value of the column tagcol, returns the default value if the column is null
    const std::string &getValueOfTagcol() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<std::string> &getTagcol() const noexcept;
    ///Set the value of the column tagcol
    void setTagcol(const std::string &pTagcol) noexcept;
    void setTagcol(std::string &&pTagcol) noexcept;
    void setTagcolToNull() noexcept;
  ...
  private:
    ...
    std::shared_ptr<std::string> tagcol_;
    struct MetaData
    {
