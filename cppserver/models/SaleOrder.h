...
class SaleOrder
{
  public:
     ...
     */
    explicit SaleOrder(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;
  ...
  private:
    friend drogon::orm::Mapper<SaleOrder>;
    friend drogon::orm::BaseBuilder<SaleOrder, true, true>;
    friend drogon::orm::BaseBuilder<SaleOrder, true, false>;
    friend drogon::orm::BaseBuilder<SaleOrder, false, true>;
    friend drogon::orm::BaseBuilder<SaleOrder, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<SaleOrder>;
#endif
