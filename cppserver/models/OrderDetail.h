...
class OrderDetail
{
  public:
     ...
     */
    explicit OrderDetail(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit OrderDetail(const Json::Value &pJson) noexcept(false);
     ...
     */
    OrderDetail(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
    ...
    void setUnitPriceToNull() noexcept;
    ...
    SaleOrder getSaleOrder(const drogon::orm::DbClientPtr &clientPtr) const;
    void getSaleOrder(const drogon::orm::DbClientPtr &clientPtr,
    ...
    void getProduct(const drogon::orm::DbClientPtr &clientPtr,
                    ...
                    const drogon::orm::ExceptionCallback &ecb) const;
  private:
    friend drogon::orm::Mapper<OrderDetail>;
    friend drogon::orm::BaseBuilder<OrderDetail, true, true>;
    friend drogon::orm::BaseBuilder<OrderDetail, true, false>;
    friend drogon::orm::BaseBuilder<OrderDetail, false, true>;
    friend drogon::orm::BaseBuilder<OrderDetail, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<OrderDetail>;
#endif
