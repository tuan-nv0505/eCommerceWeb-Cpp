...
#ifndef DROGONSERVER_PRODUCTCONTROLLER_H
#define DROGONSERVER_PRODUCTCONTROLLER_H
...
class ProductController : public drogon::HttpController<ProductController>, BaseController
{
private:
...
public:
    METHOD_LIST_BEGIN
        ...
        ADD_METHOD_TO(ProductController::remove, "/api/products/{id}", drogon::Delete);
    METHOD_LIST_END
    ...
    drogon::Task<drogon::HttpResponsePtr> detail(drogon::HttpRequestPtr request, int id);
    drogon::Task<drogon::HttpResponsePtr> remove(drogon::HttpRequestPtr request, int id);
};
