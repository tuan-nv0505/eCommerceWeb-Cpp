...
#ifndef DROGONSERVER_FILEMULTIPARSER_H
#define DROGONSERVER_FILEMULTIPARSER_H
...
public:
    ...
    std::vector<drogon::HttpFile> getMultipleFilesByField(std::string fieldName) const {
