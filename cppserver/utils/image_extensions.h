...
#ifndef CPPSERVER_IMAGE_EXTENSIONS_H
#define CPPSERVER_IMAGE_EXTENSIONS_H
...
inline std::vector<std::string> getAll() { return {PNG, JPG, JPEG, WEBP, GIF}; }
} // namespace ImageType

#endif // CPPSERVER_IMAGE_EXTENSIONS_H
